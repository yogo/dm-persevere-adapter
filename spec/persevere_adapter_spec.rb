...
describe DataMapper::Adapters::PersevereAdapter do
  ...
  describe 'associations' do
    ...
    it "should be able to handle collections of relationships" do
      ...
      bpost = BlogPost.create(:title => "A new post", :body => "This one will have many comments")
      bpost2 = BlogPost.create(:title => "Robbie post", :body => "")
      comment = Comment.create(:contents => "I think the post is great!", :rating => 4)
      comment2 = Comment.create(:contents => "Test", :rating => 2)
      
#      bpost.comments << Comment.create(:contents => "This is the best", :rating => 5)
      bpost.comments << comment
      bpost.save
      
      bpost.comments << comment2
      ...
      bpost.comments << Comment.create(:contents => "No, this is the best!", :rating => 3)
      bpost.save
